...
- [x] 一時検証ページの削除と最終dist/docs一致（公開版も404を確認）
- [x] 完了時に全項目を照合し、未確認を明示

## 実測結果

再開後の最終公開確認：最新main `3b3d96de49c9d4e23a9dd7c269dc46b207b08136` が前回成果物と一致。公開5記事・トップ・sitemapがすべてHTTP 200かつ最新docsとバイト一致。`qa-preview.html` はHTTP 404で撤去済み。ローカルの18ページ検査と5記事専用検査も再合格。前回利用上限で止まったデプロイ後の確認を完了し、今回の記事制作に関する必須チェック項目に未実施なし。
