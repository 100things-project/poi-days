...
<p class="section-lead">紹介コード、今月の特典、安全性、評判、登録方法、登録トラブル、ポイント未反映。知りたい順にどうぞ。</p>
...
<a href="articles/moppy-registration-trouble.html" style="display:flex;gap:16px;justify-content:space-between;align-items:center;padding:18px 4px;border-bottom:1px solid #e7e2dc;text-decoration:none"><span><strong>登録できないとき</strong><br><small>メール・電話番号認証の確認手順</small></span><span aria-hidden="true">→</span></a>
...
print('Moppy hub navigation built: 10 article routes linked before ranking')
