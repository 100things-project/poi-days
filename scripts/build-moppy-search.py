...
ARTICLES=[
 ('moppy-referral-code','【2026年9月】モッピー紹介コードはどこ？入力方法・後付け・特典を解説','紹介コード','JOIN SMART','モッピーの紹介コードJh7He170の入力場所、紹介リンクとの違い、後付けできるか、2026年9月の紹介特典を公式情報で解説。'),
 ('moppy-september-campaign','【2026年9月】モッピー新規登録キャンペーン｜入会特典と条件を解説','9月キャンペーン','SEPTEMBER 2026','2026年9月のモッピー友達紹介・新規登録キャンペーンを解説。紹介された人の30P、条件付き2,000P特典、5,000Pの対象者を整理。'),
 ('moppy-pros-cons','モッピーのメリット・デメリット｜登録前に知りたい注意点','メリット・デメリット','BEFORE YOU JOIN','モッピーのメリットとデメリットを公式情報をもとに整理。1P=1円、貯め方や交換先の幅、案件条件、ポイント有効期限など登録前の注意点を解説。'),
]
